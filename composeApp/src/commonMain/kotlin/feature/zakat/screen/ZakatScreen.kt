    ...
    override fun Content() {
        ...
        Scaffold(
                        ...
                        0 -> {
                            ZakatFitrahContent(
                                onCalculateClick = { valuePeople, valueRicePrice ->
                                    screenModel.calculateFitrah(valuePeople, valueRicePrice)
                                },
                            )
                        }
            ...
            if (state.zakatResultState != ZakatScreenModel.State.ZakatDialogState.Hide) {
                ...
                BaseDialog(
                    onDismissRequest = { screenModel.hideDialog() },
